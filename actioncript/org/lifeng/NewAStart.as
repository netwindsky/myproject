package org.lifeng {
	...
	public class NewAStart extends Sprite {
		...
		private function makeGrid():void {
			var rows:int = 500//int(numRows.getValue());
			var cols:int = 500//int(numCols.getValue());
			_cellSize = 3//int(cellSize.getValue());
			_grid = new Grid(cols, rows);
			for (var i:int = 0; i < rows * cols * Number(0.1); i++){
