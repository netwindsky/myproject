package org.lifeng.display
{
	 ...
	 * 备注：动态文本滚动条
	 */
	public class TextFeildScrollBar extends Sprite {
		 ...
		 * @param width_fc：滚动条宽
		 */
		public function TextFeildScrollBar(scrollText_fc : TextField, scrollBarMc_fc : Sprite, height_fc : uint = 0,width_fc : uint = 0) {
